...
<html lang="en">
   ...
   include_once "conexion.php";
      ...
      if (isset($_POST['button'])){
        ...
        if (isset($nom)  && isset($prénom) && isset($age)) {
          ...
          $req = mysqli_query($cone,"UPDATE employé SET nom='$nom',prenom='$prénom',age='$age'WHERE id = $id");
        if ($req) {
  ...
  <button type="submit" name="button"class="btn btn-primary">Modifier</button>
</form>
  </body>
</html>
